...
* [Spatial Inputs](analysis-preparation/spatial-inputs/README.md)
  ...
  * [2. Parcel-level Exclusions](analysis-preparation/spatial-inputs/2.-parcel-level-exclusions/README.md)
    * [2-1. Excluding Points](analysis-preparation/spatial-inputs/2.-parcel-level-exclusions/2-1.-excluding-points.md)
    * [2-2. Excluding Lines](analysis-preparation/spatial-inputs/2.-parcel-level-exclusions/2-2.-excluding-lines.md)
    * [2-3. Excluding Polygons](analysis-preparation/spatial-inputs/2.-parcel-level-exclusions/2-3.-excluding-polygons.md)
    * [2-4. Excluded Parcel IDs](analysis-preparation/spatial-inputs/2.-parcel-level-exclusions/2-4.-excluded-parcel-ids.md)
