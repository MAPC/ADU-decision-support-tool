...
### 4d. Parcel attributes, such as Land Use Code, that are already present in "AllParcels"&#x20;

\[TO WRITE]

### 4e. Parcel attributes, such as an existing ADU, that are not present within "AllParcels" and must be joined to it
